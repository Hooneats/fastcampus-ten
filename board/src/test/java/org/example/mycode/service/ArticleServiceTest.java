...
import org.example.mycode.service.HashtagService;
...
public class ArticleServiceTest {
    ...
    @InjectMocks // 목을 주입할 대상
    private ArticleService sut; //system under test -> 테스트 해야할 대상
    ...
    void givenNoSearchParameters_whenSearchingArticles_thenReturnsArticlePage() {
        ...
        then(articleRepository).should().findAll(pageable); // findAll 을 한번 호출 하였는가
    }
    ...
    void givenSearchParameters_whenSearchingArticles_thenReturnsArticlePage() {
        ...
        // -> findByTitleContaining 를 한번 호출 하였는가
    }
