package org.example.mycode.controller;

import org.example.mycode.config.TestSecurityConfig;
import org.example.mycode.domain.type.FormStatus;
...
import org.example.mycode.record.HashtagDto;
import org.example.mycode.record.UserAccountDto;
import org.example.mycode.record.request.ArticleRequest;
import org.example.mycode.record.response.ArticleResponse;
import org.example.mycode.service.ArticleService;
import org.example.mycode.service.PaginationService;
import org.example.mycode.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    void givenNothing_whenRequestingArticlesView_thenReturnsArticlesView() throws Exception {
        ...
        mvc.perform(get("/articles"))
                ...
                .andExpect(model().attributeExists("articles")) // 있나없나존재여부
